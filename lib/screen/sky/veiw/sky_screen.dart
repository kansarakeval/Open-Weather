        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              icon: Icon(
                  providerw!.cityList!.contains(providerr!.skySearch) == true
                      ? Icons.star
                      : Icons.star_border),
            ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Id: ${providerw!.skyModel!.weatherList![0]
                                        .id}",
                                    style:
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Speed: ${providerw!.skyModel!.windModel!
                                        .speed}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                                  ...
                                  Text(
                                    "Deg: ${providerw!.skyModel!.windModel!
                                        .deg}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Temp: ${providerw!.skyModel!.mainModel!
                                        .temp}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                                  ...
                                  Text(
                                    "Feels_like: ${providerw!.skyModel!
                                        .mainModel!.feels_like}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                                  const SizedBox(
                                  ...
                                  Text(
                                    "Temp_min: ${providerw!.skyModel!.mainModel!
                                        .temp_min}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                                  ...
                                  Text(
                                    "Temp_max: ${providerw!.skyModel!.mainModel!
                                        .temp_max}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                                  ...
                                  Text(
                                    "Pressure: ${providerw!.skyModel!.mainModel!
                                        .pressure}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                                  ...
                                  Text(
                                    "Humidity: ${providerw!.skyModel!.mainModel!
                                        .humidity}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "Country: ${providerw!.skyModel!.sysModel!
                                        .country}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                                  ...
                                  Text(
                                    "Sunrise: ${providerw!.skyModel!.sysModel!
                                        .sunrise}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
                                  ...
                                  Text(
                                    "Sunset: ${providerw!.skyModel!.sysModel!
                                        .sunset}",
                                    style:
                                    const TextStyle(fontSize: 15),
                                  ),
